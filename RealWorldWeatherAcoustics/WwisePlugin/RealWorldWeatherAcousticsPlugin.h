...
public:
    ...
    /// Report the authored source duration to Wwise Transport.
    bool GetSourceDuration(double& out_minDuration, double& out_maxDuration) const override;
